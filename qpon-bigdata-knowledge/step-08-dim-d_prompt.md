...
Step08 dim-d: drill decision/failure modes; do not redo Step05; dags/ only; next dim/dwd-h: do not copy dwd_h daily-sensor-waiting-hourly pattern; order hour tables MERGE ON id not cross-shard unique; settle missing tables may still look TI-green
...
[Role] 业务语义深度解读专家。
你的任务是为 DIM维度层日时批 模块生成业务语义深度解读文档——
...
- `dws_qpon_device_active_info_inc_d`
- `qpon_rpt_d`
- `qpon_dim_h`
...
[Action]
在 qpon-bigdata-knowledge/ 目录下生成 08d_Module_DIM维度层日时批.md
