...
Step08 dwd-d: drill decision/failure modes; do not redo Step05; dags/ only; next dwd-d/h: verify waited dim tasks still live; forbid daily create_external_sensor waiting hourly dim/ods - use Skip like dim_h; settle/product dims need partition and 2999-12-31 check; order JOIN
...
**核心类清单**（从 Step 05 提取）：
- - `qpon_dim_d/qpon_dim_d.py`
- `qpon_dim_d`
- `qpon_ods_d`
- `qpon_dwd_d`
- `qpon_dws_d`
- `qpon_dwd_d/qpon_dwd_d.py`
- `qpon_dws_d/qpon_dws_d.py`
- `qpon_search_d/…fea_export`
- `qpon_search_store_fea_export`
- `dag_name="qpon_dwd_d"`
- `qpon_search_d/…fea_export.py`
- `qpon_rpt_d`
- `qpon_ods_d_test`
- `qpon_dwd_d_test`
- `qpon_tag_d_test`
- `qpon_data_server_d_test`
- `qpon_email_date_d_test`
...
[Action]
在 qpon-bigdata-knowledge/ 目录下生成 08e_Module_DWD明细日批.md
