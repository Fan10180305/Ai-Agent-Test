...
Step08 ops-staging: drill decision/failure modes; do not redo Step05; dags/ only; next ops-staging/final: verify Unpause+gcp_alter_webhook_url; wire etl_alter+TeamtalkRobot before delete hardcoded tokens; distinguish meta swallow-green vs data_server ES raise-red; never use meta da
...
[Role] 业务语义深度解读专家。
你的任务是为 运维清理与Dataproc接入 模块生成业务语义深度解读文档——
...
[Action]
在 qpon-bigdata-knowledge/ 目录下生成 08m_Module_运维清理与Dataproc接入.md
