...
Step08 tag-d: drill decision/failure modes; do not redo Step05; dags/ only; next tag/final: hour upstream use Skip; distinguish day voucher RETURN vs hour passthrough; reconcile dim day vs 2999; orphan/ES swallowed SUCCESS not readiness; device_active fanout risk is on tag/da
...
[Action]
在 qpon-bigdata-knowledge/ 目录下生成 08j_Module_标签生产日批.md
