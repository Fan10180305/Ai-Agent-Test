...
Step08 rpt-d: drill decision/failure modes; do not redo Step05; dags/ only; next rpt: hour consumers use Skip; do not mix day/hour voucher order_status; reconcile merchant dim day-partition vs 2999; ignore Dummy/orphan sensors as readiness; assess device_active naked-read and
...
**核心类清单**（从 Step 05 提取）：
- - `qpon_rpt_d/qpon_rpt_d.py`
- `qpon_rpt_d`
- `create_external_marker`
- `qpon_analyst_alarm_{d,h}`
- `qpon_analyst_h`
- `qpon_daily_report`
- `ExternalTaskSensor`
- `qpon_rpt_d.rpt_business_indicator_summary_d`
- `qpon_ods_d`
- `qpon_dwd_d`
- `qpon_dim_d`
- `qpon_dws_d`
- `dags/airflow_config/create_external_sensor.py`
- `dags/qpon_ods_d/qpon_ods_d.py`
- `dags/qpon_dwd_d/qpon_dwd_d.py`
- `dags/qpon_daily_report/qpon_daily_report.py`
- `dags/qpon_rpt_d/qpon_rpt_d.py`
- `dags/qpon_dws_h`
...
[Action]
在 qpon-bigdata-knowledge/ 目录下生成 08h_Module_RPT报表日批.md
