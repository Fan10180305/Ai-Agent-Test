...
Step08 module deep-dive for airflow-config: drill decision points/failure modes; do not redo Step05 call chains; dags/ only; prioritize Composer slots, gcp_monitoring_alert pause, hardcoded TT tokens, ES credential logs
...
[Role] 业务语义深度解读专家。
你的任务是为 共享编排工厂与告警 模块生成业务语义深度解读文档——
...
[Action]
在 qpon-bigdata-knowledge/ 目录下生成 08a_Module_共享编排工厂与告警.md
