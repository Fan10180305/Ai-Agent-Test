...
Step08 dws-d: drill decision/failure modes; do not redo Step05; dags/ only; next dws/rpt: consumers must use Skip not daily-sensor-for-hourly; do not assume hour/day voucher order_status same aftersale rewrite; reconcile daily merchant dim freshness vs 2999 path; check_allowe
...
[Role] 业务语义深度解读专家。
你的任务是为 DWS汇总层日时批 模块生成业务语义深度解读文档——
...
[Action]
在 qpon-bigdata-knowledge/ 目录下生成 08g_Module_DWS汇总层日时批.md
