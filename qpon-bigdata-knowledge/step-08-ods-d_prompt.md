...
Step08 module deep-dive for ods-d: drill decision points/failure modes; do not redo Step05 call chains; dags/ only; prioritize Composer slots, gcp_monitoring_alert pause, hardcoded TT tokens, ES credential logs
...
[Role] 业务语义深度解读专家。
你的任务是为 ODS日批贴源层 模块生成业务语义深度解读文档——
...
[Task: ODS日批贴源层 模块深度解读]

### 扫描范围

**核心类清单**（从 Step 05 提取）：
- - `qpon_ods_d/qpon_ods_d.py`
- `qpon_ods_d`
...
[Action]
在 qpon-bigdata-knowledge/ 目录下生成 08b_Module_ODS日批贴源层.md
