...
Step08 rpt-h: drill decision/failure modes; do not redo Step05; dags/ only; next rpt-h/tag: hour consumers use Skip forbid daily-sensor-for-hourly; do not apply day voucher RETURN semantics to voucher_h; reconcile merchant dim day vs 2999; orphan sensors and ES swallowed SUCC
...
[Role] 业务语义深度解读专家。
你的任务是为 RPT报表小时批 模块生成业务语义深度解读文档——
...
[Action]
在 qpon-bigdata-knowledge/ 目录下生成 08i_Module_RPT报表小时批.md
