...
Step08 analyst-serving: drill decision/failure modes; do not redo Step05; dags/ only; next analyst-serving/final: hour upstream Skip; distinguish day RETURN vs hour passthrough for voucher; reconcile dim day vs 2999; Dummy/naked start/ES swallowed SUCCESS not readiness; DWS device_acti
...
[Role] 业务语义深度解读专家。
你的任务是为 分析服务风控日报出口 模块生成业务语义深度解读文档——
...
- - `dags/qpon_analyst_d/`
- `dags/qpon_risk_d/`
- `dags/qpon_daily_report/`
- `dags/qpon_data_server_d/`
...
[Action]
在 qpon-bigdata-knowledge/ 目录下生成 08k_Module_分析服务风控日报出口.md
